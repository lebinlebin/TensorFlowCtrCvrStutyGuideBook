...
# coding: utf-8
"""
用tensorflow高级接口搭建wide and deep model的案例，然后切到ctr预估问题中
reference：[google官方案例](https://github.com/tensorflow/models/tree/master/official/wide_deep)

get_ipython().system('wget https://raw.githubusercontent.com/tensorflow/models/master/official/wide_deep/data_download.py')
...
get_ipython().system('python data_download.py')


# In[3]:


get_ipython().system('wget https://raw.githubusercontent.com/tensorflow/models/master/official/wide_deep/wide_deep.py')
...
get_ipython().system('python wide_deep.py')
